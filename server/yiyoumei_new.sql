...
insert  into `buycar`(`userid`,`goodsid`,`buycount`,`buysize`) values (19,'G30004',1,180),(19,'G30001',1,170);
...
CREATE TABLE `orders` (
  ...
  CONSTRAINT `orders_ibfk_3` FOREIGN KEY (`userid`) REFERENCES `user` (`userid`)
) ENGINE=InnoDB AUTO_INCREMENT=145 DEFAULT CHARSET=utf8;

/*Data for the table `orders` */

insert  into `orders`(`orderid`,`goodsid`,`userid`,`purchasetime`,`count`,`size`,`goodsstatus`) values (131,'C00003',19,'2020-01-02 15:36:03',1,180,1),(132,'G10004',19,'2020-01-02 15:36:03',1,175,1),(133,'G30001',19,'2020-01-02 15:36:03',1,170,0),(144,'C00003',19,'2020-01-02 17:27:52',1,180,1);
...
CREATE TABLE `signin` (
  ...
  `signindate` date DEFAULT NULL COMMENT '签到时期',
  `integral` int(11) DEFAULT NULL COMMENT '积分',
  KEY `userid` (`userid`),
  CONSTRAINT `signin_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `user` (`userid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Data for the table `signin` */

insert  into `signin`(`userid`,`signindate`,`integral`) values (19,'2020-01-02',1);
...
insert  into `user`(`userid`,`username`,`password`,`avatar`,`email`,`telphone`,`sex`,`user_address`) values (18,'aa123456','fa8549d6a6ed212fc277f65c6d8cc403','default','11515083@qq.com','13098027959','男','陕西省咸阳市'),(19,'a123456789','46b94547e01ea9ed21450ec3233e7136','default','a123456@qq.com','12345678963','女','陕西省咸阳市'),(20,'b123456789','bbbb','default','a12345dd6@qq.com','12345678963','女','陕西省咸阳市'),(21,'c123456789','46b94547e01ea9ed21450ec3233e7136','default','ab12345dd6@qq.com','12345678962','女','陕西省咸阳市'),(22,'d123456789','46b94547e01ea9ed21450ec3233e7136','default','d123456@qq.com','12345678963','男','陕西省咸阳市'),(23,'f123456789','46b94547e01ea9ed21450ec3233e7136','default','f123456@qq.com','12345678964','女','陕西省咸阳市'),(24,'g123456789','46b94547e01ea9ed21450ec3233e7136','default','g123456@qq.com','12345678965','女','陕西省咸阳市'),(25,'h123456789','46b94547e01ea9ed21450ec3233e7136','default','h123456@qq.com','12345678966','男','陕西省咸阳市'),(26,'i123456789','46b94547e01ea9ed21450ec3233e7136','default','i123456@qq.com','12345678967','男','陕西省咸阳市'),(27,'j123456789','46b94547e01ea9ed21450ec3233e7136','default','j123456@qq.com','12345678968','男','陕西省咸阳市'),(28,'k123456789','46b94547e01ea9ed21450ec3233e7136','default','k123456@qq.com','12345678969','女','陕西省咸阳市'),(29,'l123456789','46b94547e01ea9ed21450ec3233e7136','default','l123456@qq.com','12345678970','女','陕西省咸阳市'),(30,'m123456789','46b94547e01ea9ed21450ec3233e7136','default','m123456@qq.com','12345678971','男','陕西省咸阳市'),(31,'n123456789','46b94547e01ea9ed21450ec3233e7136','default','m123456@qq.com','12345678972','女','陕西省咸阳市');
...
CREATE TABLE `user_address` (
  ...
  CONSTRAINT `user_address_ibfk_2` FOREIGN KEY (`username`) REFERENCES `user` (`username`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;

/*Data for the table `user_address` */

insert  into `user_address`(`addressid`,`username`,`receiver`,`receivephone`,`areapath`,`detailaddress`,`isdefault`,`zipcode`,`createtime`) values (1,'a123456789','asdff','12345679812','陕西省,咸阳市,礼泉县','asdf',0,'123456','2019-12-24 19:44:30'),(2,'a123456789','asdff','12345679812','陕西省,咸阳市,礼泉县','aSDASdasd是的发送到开发好看撒地方开始打会计师电话费客户卡士大夫好看啊肯定会将按时付款速度快发货卡夫卡速度',0,'123456','2019-12-24 19:44:33'),(3,'a123456789','asdff','12345679812','陕西省,咸阳市,礼泉县','asdf',0,'123456','2019-12-24 19:44:35'),(4,'a123456789','asdffbcvbvcbv','12345679812','陕西省,咸阳市,礼泉县','asdf',1,'123456','2019-12-24 19:44:57');
...
CREATE TABLE `visited` (
  ...
  KEY `goodsid` (`goodsid`),
  KEY `userid` (`userid`),
  CONSTRAINT `visited_ibfk_1` FOREIGN KEY (`goodsid`) REFERENCES `goods` (`goodsid`),
  CONSTRAINT `visited_ibfk_2` FOREIGN KEY (`userid`) REFERENCES `user` (`userid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Data for the table `visited` */

insert  into `visited`(`goodsid`,`userid`) values ('G20001',19),('G20001',19),('G20003',19),('B00003',19),('G20001',19),('C00002',19),('G30004',19),('C20001',19),('G10004',19),('G20005',19),('B00001',19),('B00002',19),('B00003',19),('B00005',19),('B00003',19),('B00004',19),('B00001',19),('B00001',19),('B00004',19),('B00003',19),('B00001',19),('B00003',19),('B00001',19),('B00002',19),('B00003',19),('B00003',19),('B00003',19),('B00003',19),('C00002',19),('G20001',19),('B00002',19),('G20001',19),('B00002',19),('C00002',19),('G30004',19),('C00003',19),('G10004',19),('G30001',19);
